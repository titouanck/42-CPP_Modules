...
/*   Updated: 2023/06/02 19:10:38 by titouan_ck       ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main()
{
	...
	// NOT OK
	{
		// Animal	firstOne("Demogorgon");
	}

	// NOT OK
	{
		// Animal	*secondOne;
		// secondOne = new Animal("Cat");
	}
	...
	// OK!
	{
		...
		thirdOne = new Cat();
		thirdOne->newIdea("In one word: Meow");
		thirdOne->makeSound();
		delete(thirdOne);
	}
	...
	// OK!
	{
		...
		fourthOne = new Dog();
		fourthOne->newIdea("In one word: Woof");
		fourthOne->makeSound();
		delete(fourthOne);
	}
	...
	// Previous main should still work:
	previousMain();
}
